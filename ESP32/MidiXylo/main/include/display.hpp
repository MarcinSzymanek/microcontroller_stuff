...
public:
    ...
    typedef std::array<uint8_t, 2> event_data_t;
    ...
    void handle_events(uint8_t val, uint8_t dir, event_vals_t event_vals);

    void handle_pc_event(uint8_t val, uint8_t dir);
    void handle_channel_event(uint8_t val, uint8_t dir);
    void handle_transpose_event(uint8_t val, uint8_t dir);
    void handle_octave_event(uint8_t val, uint8_t dir);
